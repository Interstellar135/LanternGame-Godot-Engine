...
var is_qte_unlocked: bool = false # QTE技能状态

# 开始新游戏时重置数据
func new_game():
	current_level_path = "res://scenes/level_outdoor.tscn"
	is_qte_unlocked = false
	save_game()
...
func load_game() -> bool:
	...
	is_qte_unlocked = parsed_data.get("qte_unlocked", false)
	
	print("读档成功：关卡->", current_level_path, " QTE解锁->", is_qte_unlocked)
	return true
